...
**Status (updated 2026-05-22):** 60a + 60b + 60c + 60d ✓ closed. 60e + 61 are the only open UX-polish slices — fully parallelizable, no cross-dependencies.
...
| 60e     | Deposit UX surfaces (narrowed; legal item E)      | ⏳ Open                        | Artist deposit-settings UI + Stripe test-mode banner (yellow, when `pk_test_*`). Required exact wording: _"Inklee is built to make deposits part of the booking flow. Availability depends on your current setup and enabled features."_ Homepage card + public booking-page surface already done (the latter via L-4 Section 8 notice 2026-05-20). |
| 61      | Auth UI pass                                      | ⏳ Open                        | `docs/nav-auth-ui-audit-slice-61.md` + visual/copy fixes (auth surfaces only)                                                                                                                                                                                                                                                                       |

**Sequencing now:** 60e and 61 run in parallel — no cross-dependencies remain.

61 is an audit-and-targeted-fix slice, not a redesign. 60e is a build-the-surface slice (artist deposit-settings UI does not exist today). With Stripe now live in prod (OT-02 closed 2026-05-22), the test-mode banner gate no longer applies in production — 60e is no longer ship-blocking, just remaining polish.
...
| ---------------------------------- | ----------------------------------------------------------------------------- |
| Public launch                      | Slices 60e + 61, Phase D punch list (OT-02 + 60a–60d ✓ done)                  |
