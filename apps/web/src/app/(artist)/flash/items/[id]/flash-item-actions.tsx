  ...
  return (
    <div className="space-y-2">
      <button
        ...
        className="w-full rounded-full border border-border px-5 py-2.5 text-sm text-muted-foreground hover:text-foreground hover:border-foreground transition-colors"
      >
      ...
      <button
        ...
        disabled={archiving}
        className="w-full rounded-full border border-border px-5 py-2.5 text-sm text-destructive hover:border-destructive transition-colors disabled:opacity-50"
      >
