        ...
        <div className="space-y-3">
          ...
          {!confirmCancel ? (
            <button
              ...
              className="w-full rounded-full border border-border px-5 py-2.5 text-sm text-muted-foreground transition-colors hover:border-destructive hover:text-destructive"
            >
              Cancel request
            </button>
          ) : (
            <div className="space-y-3 rounded-md border border-destructive/50 p-4">
              ...
              <form action={cancelAction} className="flex gap-2">
                ...
                <button
                  ...
                  className="rounded-full bg-destructive px-5 py-1.5 text-sm font-medium text-white disabled:opacity-50"
                >
