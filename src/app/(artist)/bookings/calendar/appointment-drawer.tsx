          ...
          <div className="flex-1 px-5 py-5 space-y-5">
            ...
            <div className="flex flex-col gap-2 pt-2">
              <button
                ...
                className="rounded-full border border-border px-5 py-2.5 text-sm text-foreground hover:bg-muted/30 transition-colors"
              >
                Edit
              </button>
              ...
              {!confirmCancel ? (
                <button
                  ...
                  className="rounded-full border border-border px-5 py-2.5 text-sm text-muted-foreground hover:text-destructive hover:border-destructive transition-colors"
                >
                  Cancel appointment
                </button>
              ) : (
