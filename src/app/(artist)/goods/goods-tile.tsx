...
import GoodsEditModal from "./goods-edit-modal";
import {
  formatPrice,
      ...
      >
        ...
        >
          <button
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-white/60 bg-black/45 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-black/65 disabled:opacity-60"
          >
            {soldOut ? (
              <>
                <RotateCcw className="h-4 w-4" strokeWidth={2.5} /> Available
              </>
            ) : (
              <>
                <Check className="h-4 w-4" strokeWidth={2.5} /> Sold out
              </>
            )}
          </button>
          <button
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-brand-mustard px-4 py-2.5 text-sm font-semibold text-brand-charcoal transition-colors hover:opacity-90"
          >
