        ...
        <div className="flex flex-col gap-2">
          ...
          {!confirmReject ? (
            <button
              ...
              className="rounded-full border border-border px-5 py-2 text-sm text-muted-foreground hover:text-destructive hover:border-destructive transition-colors"
            >
              Reject
            </button>
          ) : (
        ...
        <div className="flex flex-col gap-2">
          ...
          {!showDepositForm ? (
            <button
              ...
              className="rounded-full border border-border px-5 py-2 text-sm text-foreground hover:bg-muted/30 transition-colors"
            >
              Request deposit
            </button>
          ) : (
