...
const WITH_NAME: ((name: string) => string)[] = [
  ...
  (n) => `Make it hurt beautifully, ${n}.`,
  (n) => `Let's ruin some perfectly good skin, ${n}.`,
  (n) => `Another day, another questionable life choice, ${n}.`,
  (n) => `Permanent decisions start here, ${n}.`,
  (n) => `Let's make regret look expensive, ${n}.`,
  (n) => `Sharp tools. Bad influence. Good morning, ${n}.`,
  (n) => `Ready to make someone's mother nervous, ${n}?`,
  (n) => `${n} returns!`,
  (n) => `What's up, ${n}?`,
  (n) => `Back at it, ${n}.`,
  (n) => `Welcome back, ${n}.`,
...
const NO_NAME: string[] = [
  ...
  "Let's ruin some perfectly good skin.",
  "Another day, another questionable life choice.",
  "Permanent decisions start here.",
  "Let's make regret look expensive.",
  "Sharp tools. Bad influence. Good morning.",
